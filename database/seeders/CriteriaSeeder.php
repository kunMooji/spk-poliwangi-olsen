...
class CriteriaSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            ['code' => 'C2', 'name' => 'Nilai Rapor Fisika', 'weight' => 0.08, 'source' => 'subject_score', 'subject' => 'physics', 'unit' => 'Skala 0-100'],
            ...
            ['code' => 'C5', 'name' => 'Nilai Rapor Bahasa Indonesia', 'weight' => 0.07, 'source' => 'subject_score', 'subject' => 'indonesian', 'unit' => 'Skala 0-100'],
            ['code' => 'C6', 'name' => 'Nilai Rapor Bahasa Inggris', 'weight' => 0.09, 'source' => 'subject_score', 'subject' => 'english', 'unit' => 'Skala 0-100'],
            ['code' => 'C7', 'name' => 'Kesesuaian Kepribadian RIASEC', 'weight' => 0.20, 'source' => 'riasec', 'subject' => null, 'unit' => 'Persentase 0-100%'],
            ['code' => 'C8', 'name' => 'Minat Urutan Prioritas Prodi', 'weight' => 0.15, 'source' => 'priority', 'subject' => null, 'unit' => 'Skor 0-100'],
