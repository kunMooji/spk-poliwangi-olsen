        ...
        <div class="grid gap-5 sm:grid-cols-2">
            <div class="sm:col-span-2">
                ...
                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                              :value="old('name', $subject->name)" placeholder="Rekayasa Perangkat Lunak" required autofocus />
            ...
            <div>
                ...
                <select id="education_level" name="education_level"
                    ...
                    @foreach ($levels as $value => $label)
                        <option value="{{ $value }}" @selected(old('education_level', $subject->education_level) === $value)>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <x-text-input id="group" name="group" type="text" class="mt-1 block w-full"
                              :value="old('group', $subject->group)" placeholder="IPA / IPS / Teknologi Informasi" />
            ...
            <div>
                ...
                <x-text-input id="code" name="code" type="text" class="mt-1 block w-full"
                              :value="old('code', $subject->code)" placeholder="otomatis dari nama" />
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
            ...
            <div>
                ...
                <x-text-input id="sort_order" name="sort_order" type="number" min="0" class="mt-1 block w-full"
                              :value="old('sort_order', $subject->sort_order ?? 0)" required />
