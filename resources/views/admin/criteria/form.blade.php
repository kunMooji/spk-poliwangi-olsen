{{-- Formulir kriteria, dipakai bersama oleh halaman tambah dan ubah. --}}
<div class="space-y-6">
        ...
        <div class="grid gap-5 sm:grid-cols-2">
            <div>
                ...
                <x-text-input id="code" name="code" type="text" class="mt-1 block w-full"
                              :value="old('code', $criterion->code)" placeholder="C10" required />
            ...
            <div>
                ...
                <x-text-input id="sort_order" name="sort_order" type="number" min="0" max="255" class="mt-1 block w-full"
                              :value="old('sort_order', $criterion->sort_order ?? 0)" required />
            ...
            <div>
                ...
                <x-text-input id="unit" name="unit" type="text" class="mt-1 block w-full"
                              :value="old('unit', $criterion->unit)" placeholder="poin / persen" />
